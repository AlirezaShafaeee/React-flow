    ...
    <div className='flex flex-col h-fit max-w-[500px] space-y-2 bg-white py-[20px] px-[18px] rounded-[20px]'>
        <div className="flex items-center mb-2 space-x-1.5">
            ...
            <div className='space-y-1.5 flex-1'>
                <h3 className="text-right text-zinc-800 text-[14px] font-bold">روزنامه جمهوری اسلامی</h3>
                {<div className='flex text-[10px] justify-between max-lg:self-start font-medium  items-center text-[#737373]'>
        ...
        <div className="w-[257px] h-[62px] text-justify text-neutral-500 text-xs font-medium leading-snug">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله...</div>
        <SubscriptionInfo comments={12.56} likes={12.57} forwards={12.57}/>
      ...
      {props.ner && <TagRow fit labels={props.ner} backgroundColor='#E0F2FF' color='#3D95D6' tagBackground='#B0DEFF' />}
        <div className={['flex w-full items-center justify-between'].join(" ")}>
